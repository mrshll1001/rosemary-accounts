...
class Customer extends \AppBundle\Entity\Customer implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Customer' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Customer' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Customer' . "\0" . 'funder', '' . "\0" . 'AppBundle\\Entity\\Customer' . "\0" . 'posts', '' . "\0" . 'AppBundle\\Entity\\Customer' . "\0" . 'user'];
        }
